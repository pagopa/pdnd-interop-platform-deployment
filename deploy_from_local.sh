...
applyKubeFile 'jobs/party-registry-proxy-refresher/configmap.yaml' $JOB_PARTY_REGISTRY_PROXY_REFRESHER_SERVICE_NAME
applyKubeFile 'jobs/party-registry-proxy-refresher/serviceaccount.yaml' $JOB_PARTY_REGISTRY_PROXY_REFRESHER_SERVICE_NAME
applyKubeFile 'jobs/party-registry-proxy-refresher/cronjob.yaml' $JOB_PARTY_REGISTRY_PROXY_REFRESHER_SERVICE_NAME "fixed" $JOB_PARTY_REGISTRY_PROXY_REFRESHER_RESOURCE_CPU $JOB_PARTY_REGISTRY_PROXY_REFRESHER_RESOURCE_MEM
