...
function loadSecrets() {
    ...
    loadSecret 'selfcare-v2' 'SELFCARE_V2_API_KEY' 'SELFCARE_V2_API_KEY' 'SELFCARE_BROKER_CONNECTION_STRING' 'SELFCARE_BROKER_CONNECTION_STRING'
...
function createIngress() {
    ...
    annotations='--annotation="alb.ingress.kubernetes.io/scheme=internal" --annotation="alb.ingress.kubernetes.io/target-type=ip" --annotation="alb.ingress.kubernetes.io/group.name=interop-be"'
...
applyKustomizeToDir 'overlays/selfcare-onboarding-consumer' $SELFCARE_ONBOARDING_CONSUMER_SERVICE_NAME $SELFCARE_ONBOARDING_CONSUMER_IMAGE_VERSION $SELFCARE_ONBOARDING_CONSUMER_RESOURCE_CPU $SELFCARE_ONBOARDING_CONSUMER_RESOURCE_MEM
