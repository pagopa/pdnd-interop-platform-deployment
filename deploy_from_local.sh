...
jobDetailsPersisterImageDigest=$(getDockerImageDigest $JOB_TENANTS_CERTIFIED_ATTRIBUTES_UPDATER_SERVICE_NAME $JOB_TENANTS_CERTIFIED_ATTRIBUTES_UPDATER_VERSION)
applyKubeFile 'jobs/tenants-certified-attributes-updater/cronjob.yaml' $JOB_TENANTS_CERTIFIED_ATTRIBUTES_UPDATER_SERVICE_NAME $jobDetailsPersisterImageDigest $JOB_DETAILS_PERSISTER_RESOURCE_CPU $JOB_DETAILS_PERSISTER_RESOURCE_MEM
...
createIngress \
    ...
    $TENANT_PROCESS_SERVICE_NAME $TENANT_PROCESS_APPLICATION_PATH $BACKEND_SERVICE_PORT
