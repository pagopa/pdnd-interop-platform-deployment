...
TOKEN_GENERATION_READMODEL_TABLE_NAME_PLATFORM="interop-platform-states-dev"
TOKEN_GENERATION_READMODEL_TABLE_NAME_TOKEN_GENERATION="interop-token-generation-states-dev"
