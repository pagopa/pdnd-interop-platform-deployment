...
STORAGE_BUCKET="interop-public-dashboards-dev-es1"
FILENAME="dev-metrics.json"

ATHENA_TOKENS_TABLE_NAME="generated_jwt_dev"
ATHENA_OUTPUT_BUCKET="interop-athena-query-results-dev-es1"
