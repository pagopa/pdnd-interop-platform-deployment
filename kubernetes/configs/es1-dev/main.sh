...
. $(pwd)/kubernetes/configs/es1-dev/authorization_platformstate_writer.sh
...
. $(pwd)/kubernetes/configs/es1-dev/certified_email_sender.sh
. $(pwd)/kubernetes/configs/es1-dev/compute_agreements_consumer.sh
. $(pwd)/kubernetes/configs/es1-dev/client_purpose_updater.sh
. $(pwd)/kubernetes/configs/es1-dev/client_readmodel_writer.sh
. $(pwd)/kubernetes/configs/es1-dev/delegation_items_archiver.sh
. $(pwd)/kubernetes/configs/es1-dev/delegation_outbound_writer.sh
. $(pwd)/kubernetes/configs/es1-dev/delegation_process.sh
. $(pwd)/kubernetes/configs/es1-dev/delegation_readmodel_writer.sh
. $(pwd)/kubernetes/configs/es1-dev/datalake_interface_exporter.sh
. $(pwd)/kubernetes/configs/es1-dev/eservice_template_process.sh
. $(pwd)/kubernetes/configs/es1-dev/eservice_template_readmodel_writer.sh
. $(pwd)/kubernetes/configs/es1-dev/eservice_template_instances_updater.sh
. $(pwd)/kubernetes/configs/es1-dev/eservice_template_outbound_writer.sh
...
. $(pwd)/kubernetes/configs/es1-dev/purpose_outbound_writer.sh
. $(pwd)/kubernetes/configs/es1-dev/purpose_process.sh
. $(pwd)/kubernetes/configs/es1-dev/purpose_readmodel_writer.sh
. $(pwd)/kubernetes/configs/es1-dev/purpose_platformstate_writer.sh
. $(pwd)/kubernetes/configs/es1-dev/tenant_outbound_writer.sh
. $(pwd)/kubernetes/configs/es1-dev/tenant_process.sh
. $(pwd)/kubernetes/configs/es1-dev/tenant_readmodel_writer.sh
. $(pwd)/kubernetes/configs/es1-dev/token-generation-readmodel-checker.sh
. $(pwd)/kubernetes/configs/es1-dev/notification_email_sender.sh
...
. $(pwd)/kubernetes/configs/es1-dev/ipa_certified_attributes_importer.sh
...
. $(pwd)/kubernetes/configs/es1-dev/producer-key-readmodel-writer.sh
. $(pwd)/kubernetes/configs/es1-dev/producer-keychain-readmodel-writer.sh
