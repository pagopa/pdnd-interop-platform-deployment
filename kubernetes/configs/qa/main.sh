...
. $(pwd)/kubernetes/configs/qa/agreement_email_sender.sh
. $(pwd)/kubernetes/configs/qa/agreement_readmodel_writer.sh
...
. $(pwd)/kubernetes/configs/qa/purpose_readmodel_writer.sh
