...
POSTGRES_PORT="5432"
CQRS_PROJECTION_DB_HOST="read-model.cluster-cfx5ud7lsyvt.eu-central-1.docdb.amazonaws.com"
...
PARTY_PROCESS_URL="https://selfcare.pagopa.it/external/party-process/v1"
PARTY_MANAGEMENT_URL="https://selfcare.pagopa.it/external/party-management/v1"
USER_REGISTRY_URL="https://selfcare.pagopa.it/user-registry/v1"
