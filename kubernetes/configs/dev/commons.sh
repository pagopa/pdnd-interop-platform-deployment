...
AUTHORIZATION_TOPIC="event-store.dev_authz.events"
...
NOTIFICATION_QUEUE_URL="https://sqs.eu-central-1.amazonaws.com/505630707203/persistence-events.fifo"
...
REPORT_SENDER="noreply@reports.dev.interop.pagopa.it"
