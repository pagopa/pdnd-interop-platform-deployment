#!/bin/bash
TOKENS_JOB_BUCKET="interop-generated-jwt-details-test-es1"
...
################################################
S3_BUCKET="interop-generated-jwt-details-test-es1"
...
AUDIT_MAX_WAIT_KAFKA_BATCH_MILLIS="25000" # 1 Hour
