...
DATALAKE_INTERFACE_EXPORTER_SERVICE_NAME="interop-be-datalake-interface-export"
...
PRODUCER_KEYCHAIN_READMODEL_WRITER_SERVICE_NAME="interop-be-producer-keychain-readmodel-writer"
...
SES_MOCK_SERVICE_NAME="ses-mock"
