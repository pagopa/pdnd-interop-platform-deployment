...
CERTIFIED_EMAIL_SENDER_SERVICE_NAME="interop-be-certified-email-sender"
...
NOTIFICATION_EMAIL_SENDER_SERVICE_NAME="interop-be-notification-email-sender"
...
JOB_IPA_CERTIFIED_ATTRIBUTES_IMPORTER_SERVICE_NAME="interop-be-ipa-certified-attributes-importer"
...
JOB_TOKEN_GENERATION_READMODEL_CHECKER_SERVICE_NAME="interop-be-token-generation-readmodel-checker"
