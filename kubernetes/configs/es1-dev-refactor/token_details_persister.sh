#!/bin/bash
TOKENS_JOB_BUCKET="interop-generated-jwt-details-refactor-dev-es1"
...
################################################
S3_BUCKET="interop-generated-jwt-details-dev-refactor-es1"
...
AUDIT_MAX_WAIT_KAFKA_BATCH_MILLIS="3600000" # 1 Hour
