...
. $(pwd)/kubernetes/configs/es1-dev-refactor/authorization_platformstate_writer.sh
...
. $(pwd)/kubernetes/configs/es1-dev-refactor/catalog_platformstate_writer.sh
...
. $(pwd)/kubernetes/configs/es1-dev-refactor/client_purpose_updater.sh
. $(pwd)/kubernetes/configs/es1-dev-refactor/client_readmodel_writer.sh
. $(pwd)/kubernetes/configs/es1-dev-refactor/delegation_process.sh
. $(pwd)/kubernetes/configs/es1-dev-refactor/delegation_readmodel_writer.sh
. $(pwd)/kubernetes/configs/es1-dev-refactor/datalake_interface_exporter.sh
...
. $(pwd)/kubernetes/configs/es1-dev-refactor/purpose_platformstate_writer.sh
...
. $(pwd)/kubernetes/configs/es1-dev-refactor/token-generation-readmodel-checker.sh
